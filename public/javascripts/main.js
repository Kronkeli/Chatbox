...
function toWall() {
    ...
    xhr_index.open("GET", "https://chatbox-project.herokuapp.com/wall");
...
function toOwnWall() {
    ...
    xhr_ownWall.open("GET", "https://chatbox-project.herokuapp.com/wall/ownWall");
...
function createPost() {
    ...
    xhr_createpost.open("POST", "https://chatbox-project.herokuapp.com/wall/createPost");
    var payload = JSON.parse(getCookie('payload'));
